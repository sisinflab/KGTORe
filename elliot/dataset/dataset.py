...
class DataSet(AbstractDataset):
    ...
    def __init__(self, config, data_tuple, side_information_data, *args, **kwargs):
        ...
        # data_tuple[0] = dataset ( non ancora mappato)
    ...
    def align_with_training(self, train, side_information_data):
        ...
        for k, v in side_information_data.__dict__.items():
            ...
            users_items.append(new_v.object.get_mapped())  # user_items = [ ( {users}, {items})] = lista di tupla composta da set_user e set_ittems
        ...
        while True:
            ...
            for us_, is_ in users_items:
                temp_users = new_users & us_   # elem in comune user train e userside, us_ = user side
