...
from .KGLightGCNEdgeModel import KGLightGCNEdgeComplexModel
from .DecisionPaths import DecisionPaths
from .LoadEdgeFeatures import LoadEdgeFeatures


class KGLightGCNEdgeComplex(RecMixin, BaseRecommenderModel):
    @init_charger
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = KGLightGCNEdgeComplexModel(
