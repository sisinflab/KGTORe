...
from data_preprocessing.filters.knowledge import LinkingCleaning, KGTrainAlignment, RemoveNoisyTriples
...
def run(data_folder):
    ...
    noisy_triples = RemoveNoisyTriples(kg=kwargs['kg'])
    kwargs['kg'] = noisy_triples.filter()['kg']
